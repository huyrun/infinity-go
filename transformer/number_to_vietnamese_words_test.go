...
func TestNumberToVietnameseWords(t *testing.T) {
	tests := []struct {
		...
		{name: "101", num: 101, word: "một trăm lẻ một"},
		{name: "104", num: 104, word: "một trăm lẻ bốn"},
		{name: "105", num: 105, word: "một trăm lẻ năm"},
		...
		{name: "501", num: 501, word: "năm trăm lẻ một"},
		{name: "504", num: 504, word: "năm trăm lẻ bốn"},
		{name: "505", num: 505, word: "năm trăm lẻ năm"},
		{name: "999", num: 999, word: "chín trăm chín mươi chín"},

		// Thousands
		{name: "1_000", num: 1_000, word: "một nghìn"},
		{name: "1_001", num: 1_001, word: "một nghìn không trăm lẻ một"},
		...
		{name: "2_005", num: 2_005, word: "hai nghìn không trăm lẻ năm"},
		...
		{name: "10_001", num: 10_001, word: "mười nghìn không trăm lẻ một"},
		...
		{name: "20_005", num: 20_005, word: "hai mươi nghìn không trăm lẻ năm"},
		{name: "20_015", num: 20_015, word: "hai mươi nghìn không trăm mười lăm"},
		{name: "20_105", num: 20_105, word: "hai mươi nghìn một trăm lẻ năm"},
		{name: "201_005", num: 201_005, word: "hai trăm lẻ một nghìn không trăm lẻ năm"},

		{name: "100_000", num: 100_000, word: "một trăm nghìn"},
		{name: "100_005", num: 100_005, word: "một trăm nghìn không trăm lẻ năm"},
		{name: "100_011", num: 100_011, word: "một trăm nghìn không trăm mười một"},
		{name: "100_100", num: 100_100, word: "một trăm nghìn một trăm"},
		{name: "101_000", num: 101_000, word: "một trăm lẻ một nghìn"},
		{name: "101_005", num: 101_005, word: "một trăm lẻ một nghìn không trăm lẻ năm"},
		...
		{name: "1_000_001", num: 1_000_001, word: "một triệu không trăm lẻ một"},
		...
		{name: "1_001_000", num: 1_001_000, word: "một triệu không trăm lẻ một nghìn"},
		...
		{name: "2_000_005", num: 2_000_005, word: "hai triệu không trăm lẻ năm"},
		{name: "2_001_005", num: 2_001_005, word: "hai triệu không trăm lẻ một nghìn không trăm lẻ năm"},
		{name: "20_000_005", num: 20_000_005, word: "hai mươi triệu không trăm lẻ năm"},
		{name: "20_010_005", num: 20_010_005, word: "hai mươi triệu không trăm mười nghìn không trăm lẻ năm"},
		{name: "200_000_005", num: 200_000_005, word: "hai trăm triệu không trăm lẻ năm"},
		...
		{name: "1_000_000_001", num: 1_000_000_001, word: "một tỷ không trăm lẻ một"},
		{name: "1_000_000_004", num: 1_000_000_004, word: "một tỷ không trăm lẻ bốn"},
		{name: "1_000_000_005", num: 1_000_000_005, word: "một tỷ không trăm lẻ năm"},
		...
		{name: "1_000_000_101", num: 1_000_000_101, word: "một tỷ một trăm lẻ một"},
		{name: "1_000_000_104", num: 1_000_000_104, word: "một tỷ một trăm lẻ bốn"},
		{name: "1_000_000_105", num: 1_000_000_105, word: "một tỷ một trăm lẻ năm"},
		...
		{name: "1_000_001_000", num: 1_000_001_000, word: "một tỷ không trăm lẻ một nghìn"},
		{name: "1_000_001_005", num: 1_000_001_005, word: "một tỷ không trăm lẻ một nghìn không trăm lẻ năm"},
		{name: "1_000_001_010", num: 1_000_001_010, word: "một tỷ không trăm lẻ một nghìn không trăm mười"},
		{name: "1_000_001_100", num: 1_000_001_100, word: "một tỷ không trăm lẻ một nghìn một trăm"},
		{name: "1_000_001_105", num: 1_000_001_105, word: "một tỷ không trăm lẻ một nghìn một trăm lẻ năm"},

		{name: "1_000_010_000", num: 1_000_010_000, word: "một tỷ không trăm mười nghìn"},
		{name: "1_000_010_005", num: 1_000_010_005, word: "một tỷ không trăm mười nghìn không trăm lẻ năm"},
		...
		{name: "1_000_100_005", num: 1_000_100_005, word: "một tỷ một trăm nghìn không trăm lẻ năm"},
		{name: "1_000_100_100", num: 1_000_100_100, word: "một tỷ một trăm nghìn một trăm"},

		{name: "1_001_000_000", num: 1_001_000_000, word: "một tỷ không trăm lẻ một triệu"},
		{name: "1_001_000_005", num: 1_001_000_005, word: "một tỷ không trăm lẻ một triệu không trăm lẻ năm"},
		{name: "1_001_000_100", num: 1_001_000_100, word: "một tỷ không trăm lẻ một triệu một trăm"},

		{name: "1_001_001_000", num: 1_001_001_000, word: "một tỷ không trăm lẻ một triệu không trăm lẻ một nghìn"},
		{name: "1_001_001_005", num: 1_001_001_005, word: "một tỷ không trăm lẻ một triệu không trăm lẻ một nghìn không trăm lẻ năm"},

		{name: "1_010_000_000", num: 1_010_000_000, word: "một tỷ không trăm mười triệu"},
		{name: "1_010_000_005", num: 1_010_000_005, word: "một tỷ không trăm mười triệu không trăm lẻ năm"},
		{name: "1_010_001_005", num: 1_010_001_005, word: "một tỷ không trăm mười triệu không trăm lẻ một nghìn không trăm lẻ năm"},

		{name: "1_100_000_000", num: 1_100_000_000, word: "một tỷ một trăm triệu"},
		{name: "1_100_000_005", num: 1_100_000_005, word: "một tỷ một trăm triệu không trăm lẻ năm"},
		{name: "1_100_001_005", num: 1_100_001_005, word: "một tỷ một trăm triệu không trăm lẻ một nghìn không trăm lẻ năm"},

		{name: "2_000_000_005", num: 2_000_000_005, word: "hai tỷ không trăm lẻ năm"},
		{name: "2_001_004_005", num: 2_001_004_005, word: "hai tỷ không trăm lẻ một triệu không trăm lẻ bốn nghìn không trăm lẻ năm"},
		{name: "20_000_000_005", num: 20_000_000_005, word: "hai mươi tỷ không trăm lẻ năm"},
		{name: "200_000_000_005", num: 200_000_000_005, word: "hai trăm tỷ không trăm lẻ năm"},
		...
		{name: "201_004_005_005", num: 201_004_005_005, word: "hai trăm lẻ một tỷ không trăm lẻ bốn triệu không trăm lẻ năm nghìn không trăm lẻ năm"},
		...
		{name: "9_223_372_036_854_775_807", num: math.MaxInt64, word: "chín tỷ tỷ hai trăm hai mươi ba triệu tỷ ba trăm bảy mươi hai nghìn tỷ không trăm ba mươi sáu tỷ tám trăm năm mươi bốn triệu bảy trăm bảy mươi lăm nghìn tám trăm lẻ bảy"},

		{name: "-0", num: -0, word: "không"},
		{name: "-1", num: -1, word: "âm một"},
		{name: "-9_223_372_036_854_775_808", num: math.MinInt64, word: "âm chín tỷ tỷ hai trăm hai mươi ba triệu tỷ ba trăm bảy mươi hai nghìn tỷ không trăm ba mươi sáu tỷ tám trăm năm mươi bốn triệu bảy trăm bảy mươi lăm nghìn tám trăm lẻ tám"},
	}
