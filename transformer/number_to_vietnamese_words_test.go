...
func TestNumberToVietnameseWords(t *testing.T) {
	tests := []struct {
		...
		{name: "9_223_372_036_854_775_807", num: math.MaxInt64, word: "chín tỷ tỷ hai trăm hai mươi ba triệu tỷ ba trăm bảy mươi hai nghìn tỷ không trăm ba mươi sáu tỷ tám trăm năm mươi bốn triệu bảy trăm bảy mươi lăm nghìn tám trăm linh bảy"},

		{name: "-0", num: -0, word: "không"},
		{name: "-1", num: -1, word: "âm một"},
		{name: "-9_223_372_036_854_775_808", num: math.MinInt64, word: "âm chín tỷ tỷ hai trăm hai mươi ba triệu tỷ ba trăm bảy mươi hai nghìn tỷ không trăm ba mươi sáu tỷ tám trăm năm mươi bốn triệu bảy trăm bảy mươi lăm nghìn tám trăm linh tám"},
	}
